                    ...
                    <div className="flex-1 max-w-2xl mr-16">
                      <div className="grid grid-cols-2 gap-12">
                        ...
                        <div className="space-y-4">
                          ...
                          <Link to="/about/sustainability" className="flex items-center p-3 rounded-lg text-gray-700 hover:text-gray-900 hover:bg-gray-50 transition-all duration-300 transform hover:scale-105 hover:shadow-md group">
                            <Leaf size={20} className="mr-4 text-gray-400 group-hover:text-gray-600 transition-colors" />
                            <div>
                              <div className="font-bold text-black">{currentLanguage === 'fr' ? 'Durabilité' : 'Sustainability'}</div>
                              <div className="text-sm text-gray-500">{currentLanguage === 'fr' ? 'Nos efforts en matière de durabilité' : 'Our efforts in sustainability'}</div>
                            </div>
                          </Link>
                        </div>
                      </div>
              ...
              <div className="space-y-1">
                ...
                {isMobileAboutOpen && (
                  <div className="ml-4 space-y-2 pb-2">
                    ...
                    <Link to="/about/sustainability" className="flex items-center py-2 px-4 text-sm text-secondary-600 hover:text-primary-600 hover:bg-primary-25 rounded-lg transition-all duration-300" onClick={() => setIsMenuOpen(false)}>
                      <Leaf size={16} className="mr-3 text-gray-400" />
                      <div>
                        <div className="font-medium">{currentLanguage === 'fr' ? 'Durabilité' : 'Sustainability'}</div>
                        <div className="text-xs text-gray-500">{currentLanguage === 'fr' ? 'Nos efforts en matière de durabilité' : 'Our efforts in sustainability'}</div>
                      </div>
                    </Link>
                  </div>
                )}
